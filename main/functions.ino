...
void angle_setup() {
  ...
  Serial.print("angle set calibrating | robot_angleX "); Serial.print(robot_angleX); Serial.print("robot_angleY "); Serial.print(robot_angleY);
  delay(1000);

  angle_calc();
  offsets.X = robot_angleX;
  offsets.Y = robot_angleY;
  Serial.print("angle set calibrated | robot_angleX "); Serial.print(robot_angleX); Serial.print("robot_angleY "); Serial.print(robot_angleY);
  delay(1000);
...
void angle_calc() {
  ...
  if (abs(angleX) > 9 || abs(angleY) > 9) vertical = false;
  if (abs(angleX) < 3 && abs(angleY) < 3) vertical = true;

  // Serial.print("CAL | AngleX: "); Serial.print(angleX); Serial.print(" AngleY: "); Serial.println(angleY);
