...
void loop() {
  ...
  if (currentT - previousT_1 >= loop_time) {
    ...
    if (vertical && calibrated) {
      ...
      // if(x_target_ang >= 5) x_target_ang = 5;
      // else if (x_target_ang <= -5) x_target_ang = -5;
      // if(y_target_ang >= 5) y_target_ang = 5;
      // else if(y_target_ang <= -5) y_target_ang = -5;
